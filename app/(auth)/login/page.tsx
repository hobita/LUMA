...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // Handled by redirect in Next.js Server Action
    }
  }
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-6 py-12">
      ...
      <div className="pointer-events-none absolute bottom-10 right-10 w-[400px] h-[400px] bg-rose-600/10 blur-[130px] rounded-full" />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-white">Welcome back, love</h1>
          <p className="mt-1 text-sm text-zinc-400">Step back into your private sanctuary</p>
        </div>
        ...
        <div className="p-8 rounded-3xl glass-panel glow-violet">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              <span>{loading ? "Opening your room..." : "Sign In"}</span>
              <ArrowRight className="w-4 h-4" />
            </button>
          </form>

          {/* Quick Demo Bypass Button for immediate review */}
        ...
        <p className="text-center mt-6 text-xs text-zinc-500">
          ...
          <Link href="/register" className="text-purple-400 hover:text-purple-300 underline underline-offset-4">
            Create a space for both of you
          </Link>
        </p>
      </div>
    </div>
